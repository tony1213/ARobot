...
public class VoiceDictate extends Voice {
     ...
     * @return
     */
    public boolean listen(String language) {
        if (mIat == null) {
            return false;
        }
        // 每次听之前要把上一次听的结果清除掉
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onBeginOfSpeech() {
            ...
            if (iVoiceDictate != null) {
                iVoiceDictate.onListenBegin();
            }
        }
        ...
        public void onError(SpeechError error) {
            ...
            if (iVoiceDictate != null) {
                iVoiceDictate.onListenError(error);
            }
        }
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            ...
            if (isLast) {
                ...
                if (iVoiceDictate != null) {
                    iVoiceDictate.onListenResult(result);
                }
            }
        }
        ...
        public void onVolumeChanged(int volume, byte[] data) {
            ...
            if (iVoiceDictate != null) {
                iVoiceDictate.onListenVolumeChanged(volume, data);
            }
        }
