...
import com.robot.et.lib.business.entity.Repo;
...
public interface GitHubAPI {
   ...
   */
    ...
    @GET("users/{user}")
    Call<String> userInfoString(@Path("user") String user);

    @GET("users/{user}")
    Observable<User> userInfoRx(@Path("user") String user);

    @GET("users/{user}")
    Observable<String> userInfoRxS(@Path("user") String user);
