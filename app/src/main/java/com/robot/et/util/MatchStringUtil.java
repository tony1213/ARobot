...
public class MatchStringUtil {
    ...
    /**
     * 获取答案
     * @param questAndAnswer 内容
     * @return
     */
    public static String getAnswer(String questAndAnswer) {
        int beginIndex = 0;
        int endIndex = 0;
        char[] str = questAndAnswer.toCharArray();
        endIndex = str.length;
        ...
        return questAndAnswer.substring(beginIndex, endIndex);
    }
     ...
     * @return
     */
    public static String getQuestion(String questAndAnswer) {
        int beginIndex = 0;
        int endIndex = 0;
        char[] str = questAndAnswer.toCharArray();
        for (int i = 0; i < str.length; i++) {
        ...
        String tempResult = questAndAnswer.substring(++beginIndex, endIndex);
